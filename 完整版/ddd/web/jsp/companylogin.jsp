...
<div class="container">
    <div class="row">
        <form class="form-signin" role="form" action="${pageContext.request.contextPath}/companylogin.action">
            ...
            <div class="col-sm-offset-4 col-sm-8">
                <a href="${pageContext.request.contextPath}/jsp/login.jsp" ><h4 style="color: black">学生登陆界面</h4></a>
            </div>
        </form>
