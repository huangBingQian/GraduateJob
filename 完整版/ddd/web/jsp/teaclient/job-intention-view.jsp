...
<head>
    ...
    <link rel="stylesheet" href="css/job-intention-view.css">
</head>
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="navbar-collapse collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="quit">
                    <li><a href="${pageContext.request.contextPath}/logout.acion">退出</a></li>
    ...
    <div class="row">
        <div class="left">
            <div class="clearfix">
                ...
                <ul class="left-menu">
                    <li><a class="active" href="#">查看就业意向</a></li>
        ...
        <div class="content">
            <div class="top">您当前的位置：首页&gt;查看就业意向
            </div>
            <h3>查看就业意向</h3>
            <hr>
            <div class="head">
                ...
                <ol class="breadcrumb">
                  <li class="active">意向薪资</li>
                  <li><a href="#">&lt;3000/月</a></li>
                  <li><a href="#">3000~5000/月</a></li>
                  <li><a href="#">5000~5000/月</a></li>
                  <li><a href="#">&gt;8000/月</a></li>
                  <li><a href="#">更多</a></li>
                </ol>
                <ol class="breadcrumb">
                  <li class="active">意向地点</li>
                  <li><a href="#">江干区</a></li>
                  <li><a href="#">上城区</a></li>
                  <li><a href="#">下城区</a></li>
                  <li><a href="#">拱墅区</a></li>
