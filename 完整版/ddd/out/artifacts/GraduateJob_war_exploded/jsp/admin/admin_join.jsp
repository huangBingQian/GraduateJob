...
<div class="container">
    <div class="row">
        <%--xx.ation&&表格--%>
        <form class="form-horizontal" role="form" method="post" action="${pageContext.request.contextPath}/addjoin.action">
    ...
    <table class="table table-striped">
        ...
        <c:forEach items="${joins}" var="join">
            <tr>
                <td >${join.talkid}</td>
                <td >${join.companyid }</td>
                <td ><a href="${pageContext.request.contextPath}/deletejoin.action?talkid=${join.talkid}&companyid=${join.companyid}">删除</a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
