...
<head>
    ...
    <title>查看宣讲会参与情况</title>

    <!-- Bootstrap core CSS -->
    <link rel="stylesheet" href="css/bootstrap.min.css">
    <link rel="stylesheet" href="css/reset.css">
    <link rel="stylesheet" href="css/collegePublicCss.css">
    <link rel="stylesheet" href="css/collegemeetingjoin.css">
        ...
        <div class="left">
            <div class="clearfix">
                ...
                <ul class="left-menu">
                    ...
                    <li><a class="active" href="#">查看宣讲会参与情况</a></li>
        ...
        <div class="content" style="background-color: #ffffff;">
            ...
            <div class="message">
                <table class="msgtable">
                    <tr>
                        <td><label>宣讲会名称</label></td>
                        <td><label>主办企业</label></td>
                        <td><label>地点</label></td>
                        <td><label>时间</label></td>
                        <td><label>签到人数</label></td>
                        <td>详细信息</td>
                    </tr>
                    <tr>
                        <td>XX宣讲会</td>
